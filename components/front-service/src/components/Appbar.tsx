...
export default function PrimarySearchAppBar() {
  ...
  const handleTunesharpIconOpen = () => {
    setTuneDialogOpen(true);
  };

  const handleTuneDialogClose = () => {
      ...
      <AppBar position="static">
        <Toolbar>
          ...
          <IconButton
              ...
              aria-haspopup="true"
              onClick={handleTunesharpIconOpen}
              color="inherit"
            >
            <TuneSharpIcon />
          </IconButton>
          ...
          <Box sx={{ display: { xs: 'none', md: 'flex' } }}>
            ...
            <IconButton onClick={() => handleMessageIconOpen('recent')} size="large" aria-label="show 4 new mails" color="inherit">
              <Badge badgeContent={4} color="error">
                <ChatIcon />
              </Badge>
            </IconButton>
